...
def all_vacancies() -> list[tuple]:
 ...
 ('1001pled.ru',
  ...
  70000.0,
  80000.0,
  'https://api.hh.ru/vacancies/123198998?host=hh.ru'),
 ('0.75 GROUP',
 ...
 ('0.75 GROUP',
  ...
  80000.0,
  None,
  'https://api.hh.ru/vacancies/121860249?host=hh.ru'),
 ('0.75 GROUP',
  'Менеджер в "12 СЛОЁВ"',
  55000.0,
  None,
  'https://api.hh.ru/vacancies/122811842?host=hh.ru'),
 ('1001 Крепеж',
  'Кладовщик',
  92000.0,
  103000.0,
 ...
 ('1001 чай',
  ...
  50000.0,
  None,
  'https://api.hh.ru/vacancies/123225259?host=hh.ru'),
 ('0sprava',
 ...
 ('0.75 GROUP',
  'Кондитер в сеть 075 GROUP',
  64000.0,
  None,
  'https://api.hh.ru/vacancies/123273683?host=hh.ru'),
 ('001KZ (001КЗ)',
 ...
 ('1001 Крепеж',
  ...
  80000.0,
  100000.0,
  'https://api.hh.ru/vacancies/122747596?host=hh.ru'),
 ('0.75 GROUP',
 ...
 ('0.75 GROUP',
  ...
  40000.0,
  None,
  'https://api.hh.ru/vacancies/122470718?host=hh.ru'),
 ('1001 Тур (ООО Оникс)',
 ...
 ('1001 Крепеж',
  ...
  45000.0,
  45000.0,
  'https://api.hh.ru/vacancies/122416182?host=hh.ru'),
 ('1001 LABS',
  'Cистемный аналитик (Senior)',
  None,
  None,
  'https://api.hh.ru/vacancies/122902506?host=hh.ru'),
 ('1000 ДЛЯ УДОБНОЙ ЖИЗНИ',
 ...
 ('0.75 GROUP',
  ...
  55000.0,
  None,
  'https://api.hh.ru/vacancies/119903597?host=hh.ru'),
 ('0250',
  'Главный бухгалтер',
  90000.0,
  None,
 ...
 ('1001 Тур',
  ...
  None,
  None,
  'https://api.hh.ru/vacancies/122344625?host=hh.ru'),
 ('1000 и одна туфелька',
 ...
 ('1001 LABS',
  ...
  None,
  None,
  'https://api.hh.ru/vacancies/122201566?host=hh.ru'),
 ('0.75 GROUP',
 ...
 ('0250',
  ...
  50000.0,
  80000.0,
  'https://api.hh.ru/vacancies/122754891?host=hh.ru'),
 ('1000 и одна туфелька',
 ...
 ('062 detail',
  ...
  60000.0,
  None,
  'https://api.hh.ru/vacancies/122462518?host=hh.ru'),
 ('1001 LABS',
...
def vacancies_with_higher_salary() -> list[tuple]:
 ...
 (121860249,
  ...
  80000.0,
  None,
  'Согласование графика семьи, репетиторов, поездок. Напоминания, '
  'планирование, “ничего не забыть”. Путешествия и визовые вопросы: '
  'Организация поездок (билеты, отели, трансферы, VIP...',
  'Опыт работы в схожей роли от 3 лет (личный ассистент, PA, дом-менеджер, '
  'lifestyle manager). Высокий уровень самоорганизации, тайм-менеджмента. '),
 (123190002,
  1826,
  'Кладовщик',
  'https://api.hh.ru/vacancies/123190002?host=hh.ru',
  ...
  'Знание 1С (желательно). Приветствуется опыт управления погрузчиком и знание '
 ...
 (122747596,
  ...
  80000.0,
  100000.0,
  'Доставка заказов по г. Москве и Московской области. Передача '
  'сопроводительной документации клиентам и возврат оформленных документов на '
  'склад. ',
  'Водительское удостоверение категории "В","С". Стаж вождения не менее 2-х '
  'лет. Знание Москвы и МО.'),
 (122316750,
  1825,
  'Менеджер по закупкам и снабжению',
  'https://api.hh.ru/vacancies/122316750?host=hh.ru',
  80000.0,
  120000.0,
  'Работа с постоянными поставщиками сырья (РФ), закупка и снабжение - Пряжа '
  '(основной материал в закупках), нитки, красители, полуфабрикаты, флис, '
  'мелкие товары...',
  'Высшее образование. В приоритеты кандидаты из сферы сувениров, мерча или '
  'закупки в легкой промышленности(Из любых направлений). Все остальные '
  'резюме...'),
 (121516429,
  1825,
  'Менеджер по продажам B2B и B2G без поиска',
